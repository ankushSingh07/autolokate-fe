...
import { HOWTO_HERO_BG, heroStats } from "./constants";
      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
        <div className="max-w-2xl">
          ...
          <p className="mt-5 max-w-xl text-base leading-relaxed text-muted-foreground sm:text-[1.05rem]">
            Autolokate QR is designed for simplicity. Follow these easy steps to secure your
